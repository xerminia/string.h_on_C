#include <stdio.h>
#ifndef SRC_S21_ERROR_LIST_H_
#define SRC_S21_ERROR_LIST_H_
#define ERRLIST                                                                \
  {                                                                            \
    "Undefined error: 0", "Operation not permitted",                           \
        ...
        "Value too large to be stored in data type", "Bad executable",         \
        "Bad CPU type in executable", "Shared library version mismatch",       \
        "Malformed Macho file", "Operation canceled", "Identifier removed",    \
